                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php 
                                        echo $this->Form->input('plat',['class' => 'form-control', 'placeholder' => 'Plat...']);
                                        ...
                                        echo $this->Form->input('type_id',['options' => $types, 'class' => 'form-control']);
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php
                                            ...
                                            echo $this->Form->input('coordinator',['class' => 'form-control', 'placeholder' => 'Coordinator...']);
